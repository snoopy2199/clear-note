...
@section('main')
    ...
    <form id="finish_regist_form" action="/api/user/update" method="post" class="form-horizontal" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="name" name="name"
                       class="form-control" id="inputName" placeholder="稱呼" required>
            </div>
        </div>
        <div class="form-group">
            <label for="inputPassword" class="col-sm-2 col-md-offset-2 control-label">密碼</label>
            <div class="col-sm-4">
                <input type="password" class="form-control" id="inputPassword" placeholder="密碼" required>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="password" name="password"
                       class="form-control" id="inputPasswordAgain" placeholder="驗證密碼" required>
            </div>
        </div>
        <div class="form-group">
